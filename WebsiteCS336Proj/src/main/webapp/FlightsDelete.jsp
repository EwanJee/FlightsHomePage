...
<body>
	...
	try {
		...
		String deleteFlight = "DELETE FROM flights WHERE fNumber=? AND lid = ?";		
		
		
		//Create a Prepared SQL statement allowing you to introduce the parameters of the query
		PreparedStatement ps2 = con.prepareStatement(deleteFlight);
		...
		out.print("Flight with the FNUM/LID PAIR: " + fNum + " " + lid +" was successfully deleted." );
		}
		else{
